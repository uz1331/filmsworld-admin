...
const TrendingMovies = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://appsdemo.pro/FilmsWorld-backend/api/user/getAllSeries") // Ensure this is the correct API
            ...
            .catch((err) => {
                setError("Error fetching trending Series.");
                console.error(err);
            })
    ...
    const handleSetTrending = (movieId) => {
        ...
        fetch("https://appsdemo.pro/FilmsWorld-backend/api/user/setTrending", {
            ...
            .then((data) => {
                if (data?.success) {
                    alert("Series marked as trending!");
                } else {
                    alert("Failed to mark Series as trending.");
                }
            })
            .catch((err) => {
                alert("Error marking Series as trending.");
                console.error(err);
            });
    };
    ...
    return (
        <div className="trending-movies-page">
            ...
            <div className="trending-header">
                ...
                <span className="movie-count">Total Series: {movies.length}</span>
            </div>
